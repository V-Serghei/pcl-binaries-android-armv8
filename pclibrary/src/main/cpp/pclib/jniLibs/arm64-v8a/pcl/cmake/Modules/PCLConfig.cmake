...
macro(find_boost)
  ...
  elseif(NOT BOOST_INCLUDEDIR)
    set(BOOST_INCLUDEDIR "/home/sitavlas/.conan/data/boost/1.70.0/bashbug/stable/package/4317d68676204855daddf9e93e50d037f61575ca/include")
...
macro(find_eigen)
  ...
  elseif(NOT EIGEN_ROOT)
    get_filename_component(EIGEN_ROOT "/home/sitavlas/.conan/data/eigen/3.3.7/_/_/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include/eigen3" ABSOLUTE)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  find_package(Eigen)
...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    get_filename_component(FLANN_ROOT "/home/sitavlas/.conan/data/flann/1.9.1/bashbug/stable/package/0ae23ce156a999016ff3644328f7150befab40a6/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/sitavlas/.conan/data/pcl/1.9.1/bashbug/stable/build/1dbc8a6a865a8fad699417711b0b0b490d4d2d18/pcl")
...
foreach(component ${PCL_TO_FIND_COMPONENTS})
  ...
  if(PCL_${COMPONENT}_FOUND)
    ...
    endforeach(int_dep)
    if(_is_header_only EQUAL -1)
      add_library(${pcl_component} STATIC IMPORTED)
      if(PCL_${COMPONENT}_LIBRARY_DEBUG)
